...
public class Reina {
	...
	private void setPosicion(Posicion posicion) {
		...
		if (posicion.getFila() >= 1 && posicion.getFila() <= 8 &&
				...
				(posicion.getColumna() == 'a' || posicion.getColumna() == 'b' || posicion.getColumna() == 'c'
						|| posicion.getColumna() == 'd' || posicion.getColumna() == 'e' || posicion.getColumna() == 'f'
						|| posicion.getColumna() == 'g' || posicion.getColumna() == 'h'))
	...
	public void mover(Direccion direccion, int pasos) throws OperationNotSupportedException, NullPointerException, IllegalArgumentException {
		...
		if (filaTemporal >= 1 && filaTemporal <= 8
				&& (colTemporal == 'a' || colTemporal == 'b' || colTemporal == 'c' || colTemporal == 'd'
						|| colTemporal == 'e' || colTemporal == 'f' || colTemporal == 'g' || colTemporal == 'h')) {
			posicionTemporal = new Posicion(filaTemporal, colTemporal);
